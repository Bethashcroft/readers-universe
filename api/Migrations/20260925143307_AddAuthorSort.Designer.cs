...
namespace ReadersRealm.Api.Migrations
{
    ...
    [Migration("20260925143307_AddAuthorSort")]
    partial class AddAuthorSort
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReadersRealm.Api.Models.LibraryEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ReadersRealm.Api.Models.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ReadersRealm.Api.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ReadersRealm.Api.Models.ReadingGoal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ReadersRealm.Api.Models.ReadingSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ReadersRealm.Api.Models.BorrowRequest", b =>
                {
                    ...
                    b.HasOne("ReadersRealm.Api.Models.LibraryEntry", "LibraryEntry")
                        .WithMany()
            ...
            modelBuilder.Entity("ReadersRealm.Api.Models.Follow", b =>
                {
                    ...
                    b.HasOne("ReadersRealm.Api.Models.AppUser", "Following")
                        .WithMany()
            ...
            modelBuilder.Entity("ReadersRealm.Api.Models.Notification", b =>
                {
                    ...
                    b.HasOne("ReadersRealm.Api.Models.AppUser", "Actor")
                        .WithMany()
