        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VintedUrl = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BorrowRequests_AspNetUsers_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BorrowRequests_AspNetUsers_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Messages_BorrowRequests_BorrowRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowRequests_FromUserId",
                table: "BorrowRequests",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowRequests_ToUserId",
                table: "BorrowRequests",
                column: "ToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Messages_BorrowRequestId",
                table: "Messages",
